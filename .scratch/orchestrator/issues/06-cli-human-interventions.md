...
- `bp-agents sdd approve <ticket-id>` — merge branch to main, transition to Done
- `bp-agents sdd reject <ticket-id> --reason "..."` — reject with reason, transition back to Implementing
- `bp-agents sdd realign <ticket-id> --acs "..."` — record AC changelog entry (ADDED/MODIFIED/REMOVED), transition back to Implementing with new ACs
- `bp-agents sdd unblock <ticket-id> [--note "..."]` — resume at blocked stage
- `bp-agents sdd status [<ticket-id>]` — show current state
...
- [ ] `bp-agents sdd approve <id>` merges feature branch to main, transitions to Done
- [ ] `bp-agents sdd reject <id> --reason "..."` transitions back to Implementing with reason in contract
- [ ] `bp-agents sdd realign <id> --acs "..."` records AC changelog entry (ADDED/MODIFIED/REMOVED), transitions to Implementing with new ACs
- [ ] `bp-agents sdd unblock <id> [--note "..."]` resumes at blocked stage
- [ ] `bp-agents sdd status [<id>]` shows current state for one or all tickets
